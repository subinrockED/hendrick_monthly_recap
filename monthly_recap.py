...
if st.button("Run script"):
    if learning_activity_file and tom_report and leaderboard_file:
        try:
            ...
            html_body = f"""
                ...
                <body>
                    ...
                    <h3 style="color: #7F27E4;">Standout Performers at {dealership_name}:</h3>
                    <ul>
                """
            ...
            html_body += f"""
                    ...
                    <h3 style="color: #7F27E4;";>Least Active Learners (4 or less learning days in {prev_month}):</h3>
                    <ul>
        ...
        st.error("All three files are required to run the script.")